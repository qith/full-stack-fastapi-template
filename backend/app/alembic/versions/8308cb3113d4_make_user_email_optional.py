...
Revision ID: 8308cb3113d4
Revises: a594dfce091f
Create Date: 2025-10-20 00:08:12.598728
...
revision = '8308cb3113d4'
down_revision = 'a594dfce091f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # 只修改 user_email 字段为可选，不删除其他表
    op.alter_column('role_assignment', 'user_email',
